...
public class DateTimeLab {
    public static void main(String[] args) {
        ...
        // changed the variable name to remove errors as the original variable name 'dtf' was also used in exercise 5

        System.out.println("Default format: " + event);
        System.out.println("Custom format: " + event.format(dateTimeFormatter));
